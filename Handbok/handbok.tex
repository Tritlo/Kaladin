...
\begin{abstract}
Kaladin er einfalt mál sem keyrir á Morpho sýndarvélinni. Í Kaladin hafa 
allar segðir gildi.
\end{abstract}
...
Kaladin þýðandinn er skrifaður í JavaScript, en til þess að þýða Kaladinskrár
...
þar sem \verb|kaladin.js| er í:

\begin{verbatim}
node kaladin.js initial.kal >> initial.masm
\end{verbatim}

en skipta má 

Kaladin þýðist yfir í Morpho vélamál. Til þess að geta notað Kaladin, þá
þarf Morpho að vera uppsett á tölvunni, en einnig má nota þá útgáfu af Morpho
sem fylgir með.
\section{Málfræði}
