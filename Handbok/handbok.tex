...
``\verb|We do|'', eða ``\verb|Then we do|'' eða ``\verb|Then we|''

þar sem f er fall skilgreint í sömu skrá, eða fall úr Morpho.
Athuguið að fjöldi inntaksstærða í fallið verður að sú sama og fallið
er skilgreint fyrir.
...
Ef sanngildi \verb|expr| er satt, þá er body1 framkvæmdur, annars
er body2 framkvæmdir.
...
Á meðan sanngildi expr er satt, þá er body framkvæmt. Athugið að sanngildi
